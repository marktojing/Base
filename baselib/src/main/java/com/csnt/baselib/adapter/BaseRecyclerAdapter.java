...
/**
 * Created by sunrain
 * Created Date 2020/6/10 1:59 PM
 */
public abstract class BaseRecyclerAdapter<T extends BaseEntity> extends RecyclerView.Adapter<BaseRecycleViewHolder> {
    ...
    public abstract void bindViewHolder(@NonNull BaseRecycleViewHolder holder, T item);
